# Salary-prediction-using-Polynomial-Linear-Regression
...
One can use the PLR model to tune their regression curve as all coefficients and regression curve equation is available
